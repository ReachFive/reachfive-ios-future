...
ifeval::["{docname}" != "sendEmailVerification"]

|[[redirectUrl,redirectUrl]] redirectUrl `string` 
| The URL to which the user is redirected.

This URL must be whitelisted in the `Allowed Callback URLs` field of your {company} client settings.
...
|[[verificationCode{sdk-code-anchor}]]verificationCode `string` 
