...
|The type of credential, passkey and/or password.
...
.options
* `Always`: If credentials are available, presents a modal sign-in sheet.
...
* `IfImmediatelyAvailableCredentials`: If credentials are available, presents a modal sign-in sheet. 
