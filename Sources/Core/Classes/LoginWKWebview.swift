...
public class LoginWKWebview: UIView {
    ...
    public func loadLoginWebview(reachfive: ReachFiveFuture, state: String? = nil, nonce: String? = nil, scope: [String]? = nil, origin: String? = nil) -> Future<AuthToken, ReachFiveError> {
