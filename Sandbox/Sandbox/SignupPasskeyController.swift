...
class SignupPasskeyController: UIViewController {
    ...
    @IBAction func signup(_ sender: Any) {
        ...
        if #available(iOS 16.0, *) {
            AppDelegate.reachfive().signup(withRequest: PasskeySignupRequest(passkeyProfile: profile, friendlyName: username, presenting: Presentation(from: self), origin: "SignupPasskeyController.signup"))
